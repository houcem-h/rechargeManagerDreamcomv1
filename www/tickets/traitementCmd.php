<?php
            ...
            //instanciation de la classe par la crréation du nouvel objet commande
            $commande = new Commande();

            //récupération des valeurs passées dans l'URL par le GET
            $idComm = $_GET['id_comm'];
            ...
            //Vérification des valeurs des tickets (1dt, 5dt et 10dt) passées dans la commande
            //et création des variables de valeurs pour chacune
            $vlr=0;
            if (isset($_GET['qte1'])) {
              $qte1 = $_GET['qte1'];
              $vlr1 = 1;
